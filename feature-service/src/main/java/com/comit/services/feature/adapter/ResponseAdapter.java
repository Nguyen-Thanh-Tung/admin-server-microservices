package com.comit.services.feature.adapter;

import com.comit.services.feature.client.AccountClient;
import com.comit.services.feature.client.UserLogClient;
import com.comit.services.feature.client.request.UserLogRequestClient;
import com.comit.services.feature.client.response.UserResponseClient;
...
public class ResponseAdapter implements ResponseBodyAdvice<Object> {
    ...
    public static LinkedHashMap<String, String> MapAPI() {
        ...
        lkMapApi.put(Const.FEATURE_AR + "_" + Const.POST, Const.ADD_FEATURE);
