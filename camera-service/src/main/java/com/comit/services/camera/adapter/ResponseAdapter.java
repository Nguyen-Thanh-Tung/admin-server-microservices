...
import com.comit.services.camera.client.request.UserLogRequestClient;
...
public class ResponseAdapter implements ResponseBodyAdvice<Object> {
    ...
    public static LinkedHashMap<String, String> MapAPI() {
        ...
        lkMapApi.put(Const.CAMERA_AR + "_" + Const.POST, Const.ADD_CAMERA);
        lkMapApi.put(Const.CAMERA_ID_AR + "_" + Const.PUT, Const.UPDATE_CAMERA);
        lkMapApi.put(Const.CAMERA_POLYGON_AR + "_" + Const.PUT, Const.UPDATE_CAMERA_POLYGON);
        lkMapApi.put(Const.CAMERA_ID_AR + "_" + Const.DELETE, Const.DELETE_CAMERA);
        return lkMapApi;
    }
}
