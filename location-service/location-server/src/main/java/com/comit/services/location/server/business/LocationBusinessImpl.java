...
import com.comit.services.location.server.middleware.LocationVerifyRequestServices;
import com.comit.services.location.server.model.Location;
import com.comit.services.location.server.service.LocationServices;
...
public class LocationBusinessImpl implements LocationBusiness {
    ...
    public List<LocationDto> getAllLocation(List<Location> locations) {
        ...
        locations.forEach(location -> {
            ...
            locationDto.setNumberEmployee(numberEmployeeOfLocation);
    ...
    public LocationDto addLocation(LocationRequest request) {
        ...
        locationDto.setNumberEmployee(0);
