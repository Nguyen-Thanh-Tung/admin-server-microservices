package com.comit.services.location.adapter;

import com.comit.services.location.client.AccountClient;
import com.comit.services.location.client.UserLogClient;
import com.comit.services.location.client.request.UserLogRequestClient;
...
public class ResponseAdapter implements ResponseBodyAdvice<Object> {
    ...
    public static LinkedHashMap<String, String> MapAPI() {
        ...
        lkMapApi.put(Const.ADD_LOCATION_AR + "_" + Const.POST, Const.ADD_LOCATION);
        lkMapApi.put(Const.LOCATION_ID_AR + "_" + Const.PUT, Const.UPDATE_LOCATION);
        lkMapApi.put(Const.LOCATION_ID_AR + "_" + Const.DELETE, Const.DELETE_LOCATION);
        return lkMapApi;
    }
}
