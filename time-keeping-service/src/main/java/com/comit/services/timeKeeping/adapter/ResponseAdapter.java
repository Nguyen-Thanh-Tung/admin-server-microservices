package com.comit.services.timeKeeping.adapter;

import com.comit.services.timeKeeping.client.AccountClient;
import com.comit.services.timeKeeping.client.UserLogClient;
...
public class ResponseAdapter implements ResponseBodyAdvice<Object> {
    ...
    public static LinkedHashMap<String, String> MapAPI() {
        ...
        lkMapApi.put(Const.SHIFT_LOCATION_ID_AR + "_" + Const.POST, Const.ADD_SHIFT_LOCATION);
        lkMapApi.put(Const.SHIFT_ID_AR + "_" + Const.PUT, Const.UPDATE_SHIFT_LOCATION);
        lkMapApi.put(Const.SHIFT_ID_AR + "_" + Const.DELETE, Const.DELETE_SHIFT_LOCATION);
        lkMapApi.put(Const.NOTIFICATION_LOCATION_ID_AR + "_" + Const.POST, Const.ADD_NOTIFICATION_LOCATION);
        lkMapApi.put(Const.NOTIFICATION_ID_AR + "_" + Const.PUT, Const.UPDATE_NOTIFICATION_ID);
        lkMapApi.put(Const.NOTIFICATION_LOCATION_ID_AR + "_" + Const.DELETE, Const.DELETE_NOTIFICATION_LOCATION);
        return lkMapApi;
    }
}
