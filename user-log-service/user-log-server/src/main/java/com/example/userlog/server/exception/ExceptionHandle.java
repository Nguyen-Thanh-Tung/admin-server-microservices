package com.example.userlog.server.exception;
...
public class ExceptionHandle {
    ...
    public ResponseEntity<BaseResponse> handleIOException(IOException ex) {
        return new ResponseEntity<>(new BaseResponse(UserLogErrorCode.INTERNAL_ERROR.getCode(), UserLogErrorCode.INTERNAL_ERROR.getMessage()), HttpStatus.BAD_REQUEST);
    }
