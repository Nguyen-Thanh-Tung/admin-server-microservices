...
import com.comit.services.employee.client.response.AreaRestrictionListResponseClient;
...
public interface AreaRestrictionClient {
    ...
    ResponseEntity<AreaRestrictionListResponseClient> getAreaRestrictionByManagerId(@RequestHeader String token, @PathVariable Integer managerId);
}
