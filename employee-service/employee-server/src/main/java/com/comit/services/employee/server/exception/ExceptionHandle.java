package com.comit.services.employee.server.exception;
...
public class ExceptionHandle {
    ...
    public ResponseEntity<BaseResponse> handleIOException(IOException ex) {
        return new ResponseEntity<>(new BaseResponse(EmployeeErrorCode.INTERNAL_ERROR.getCode(), EmployeeErrorCode.INTERNAL_ERROR.getMessage()), HttpStatus.BAD_REQUEST);
    }
