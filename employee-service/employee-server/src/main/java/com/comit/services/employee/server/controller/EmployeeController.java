package com.comit.services.employee.server.controller;
...
import com.comit.services.employee.client.response.BaseResponse;
import com.comit.services.employee.client.response.CountEmployeeResponse;
import com.comit.services.employee.client.response.EmployeeListResponse;
import com.comit.services.employee.client.response.EmployeeResponse;
import com.comit.services.employee.server.business.EmployeeBusiness;
...
public class EmployeeController {
    ...
    public ResponseEntity<BaseResponse> getAllEmployee(
        ...
        return new ResponseEntity<>(new EmployeeListResponse(EmployeeErrorCode.SUCCESS.getCode(), EmployeeErrorCode.SUCCESS.getMessage(), employeeDtos, currentPage, totalItems, totalPages), HttpStatus.OK);
    }
    ...
    public ResponseEntity<BaseResponse> getEmployee(@PathVariable int id) {
        ...
        return new ResponseEntity<>(new EmployeeResponse(EmployeeErrorCode.SUCCESS.getCode(), EmployeeErrorCode.SUCCESS.getMessage(), employeeDto), HttpStatus.OK);
    }
    ...
    public ResponseEntity<BaseResponse> deleteEmployee(@PathVariable int id) {
        ...
        if (deleteSuccess) {
            return new ResponseEntity<>(new BaseResponse(EmployeeErrorCode.SUCCESS.getCode(), EmployeeErrorCode.SUCCESS.getMessage()), HttpStatus.OK);
        }
        return new ResponseEntity<>(new BaseResponse(EmployeeErrorCode.FAIL.getCode(), EmployeeErrorCode.FAIL.getMessage()), HttpStatus.OK);
    }
    ...
    public ResponseEntity<BaseResponse> getNumberEmployeesOfLocation(@PathVariable Integer locationId) {
        ...
        return new ResponseEntity<>(new CountEmployeeResponse(EmployeeErrorCode.SUCCESS.getCode(), EmployeeErrorCode.SUCCESS.getMessage(), numberEmployeeOfLocation), HttpStatus.OK);
    }
}
