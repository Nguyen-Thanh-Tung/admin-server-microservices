package com.comit.services.metadata.adapter;

import com.comit.services.metadata.client.AccountClient;
import com.comit.services.metadata.client.UserLogClient;
import com.comit.services.metadata.client.request.UserLogRequestClient;
import com.comit.services.metadata.client.response.UserResponseClient;
import com.comit.services.metadata.constant.Const;
...
public class ResponseAdapter implements ResponseBodyAdvice<Object> {
    ...
    public static LinkedHashMap<String, String> MapAPI() {
        ...
        lkMapApi.put(Const.SAVE_METADATA_FILE_AR + "_" + Const.POST, Const.SAVE_FILE);
        lkMapApi.put(Const.PATH_FILE + "_" + Const.POST, Const.SAVE_METADATA_PATH_AR);
        return lkMapApi;
    }
}
