package com.comit.services.areaRestriction.adapter;

import com.comit.services.areaRestriction.client.AccountClient;
import com.comit.services.areaRestriction.client.UserLogClient;
import com.comit.services.areaRestriction.client.request.UserLogRequestClient;
...
public class ResponseAdapter implements ResponseBodyAdvice<Object> {
    ...
    public static LinkedHashMap<String, String> MapAPI() {
        ...
        lkMapApi.put(Const.AREA_AR + "_" + Const.POST, Const.ADD_AREA);
        lkMapApi.put(Const.AREA_ID_AR + "_" + Const.PUT, Const.UPDATE_AREA);
        lkMapApi.put(Const.AREA_ID_AR + "_" + Const.DELETE, Const.DELETE_AREA);
        lkMapApi.put(Const.AREA_ID_NOTIFICATION_AR + "_" + Const.PUT, Const.UPDATE_AREA_NOTIFICATION);
        lkMapApi.put(Const.AREA_MANAGER_AR + "_" + Const.DELETE, Const.DELETE_AREA_MANAGER);
        lkMapApi.put(Const.AREA_MANAGER_NOTIFICATION_AR + "_" + Const.DELETE, Const.DELETE_AREA_MANAGER_NOTIFICATION);
        lkMapApi.put(Const.AREA_EMPLOYEE_TIME_AR + "_" + Const.POST, Const.ADD_AREA_EMPLOYEE_TIME);
        return lkMapApi;
    }
}
