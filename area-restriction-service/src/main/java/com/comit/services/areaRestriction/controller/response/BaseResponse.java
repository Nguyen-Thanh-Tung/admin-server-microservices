...
public class BaseResponse implements Serializable {
    ...
    public BaseResponse() {
        this.code = AreaRestrictionErrorCode.SUCCESS.getCode();
        this.message = AreaRestrictionErrorCode.SUCCESS.getMessage();
    }
    ...
    public BaseResponse(AreaRestrictionErrorCode errorCode) {
