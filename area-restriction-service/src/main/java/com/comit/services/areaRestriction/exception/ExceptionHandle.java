package com.comit.services.areaRestriction.exception;
...
public class ExceptionHandle {
    ...
    public ResponseEntity<BaseResponse> handleIOException(IOException ex) {
        return new ResponseEntity<>(new BaseResponse(AreaRestrictionErrorCode.INTERNAL_ERROR), HttpStatus.BAD_REQUEST);
    }
