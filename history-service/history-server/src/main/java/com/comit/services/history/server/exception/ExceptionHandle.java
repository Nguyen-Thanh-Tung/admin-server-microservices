package com.comit.services.history.server.exception;
...
public class ExceptionHandle {
    ...
    public ResponseEntity<BaseResponse> handleIOException(IOException ex) {
        return new ResponseEntity<>(new BaseResponse(HistoryErrorCode.INTERNAL_ERROR.getCode(), HistoryErrorCode.INTERNAL_ERROR.getMessage()), HttpStatus.BAD_REQUEST);
    }
