package com.comit.services.organization.server.exception;
...
public class ExceptionHandle {
    ...
    public ResponseEntity<BaseResponse> handleIOException(IOException ex) {
        return new ResponseEntity<>(new BaseResponse(OrganizationErrorCode.INTERNAL_ERROR.getCode(), OrganizationErrorCode.INTERNAL_ERROR.getMessage()), HttpStatus.BAD_REQUEST);
    }
