package com.comit.services.organization.exception;
...
public class ExceptionHandle {
    ...
    public ResponseEntity<BaseResponse> handleIOException(IOException ex) {
        return new ResponseEntity<>(new BaseResponse(OrganizationErrorCode.INTERNAL_ERROR), HttpStatus.BAD_REQUEST);
    }
